...
<body>
    <div class="container">
        ...
        <div class="inv-header">
            <div>
                <h2 style="color: #ff9b00">RENT ROVER</h2>
                <ul>
                    <li>Naqab Al Dabour</li>
                    <li>Salt, Jordan</li>
                    <li>+962-790842321 | Rent.Rover@outlook.com</li>
                </ul>
                <h2>Client</h2>
                <ul>
        ...
        <h3 style="text-align: center; margin-top: 30px">Thank you for using our web application to make your reservation. We appreciate your trust in our car rental services.</h3>
    </div>
    <script>
