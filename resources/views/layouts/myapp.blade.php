...
<body class="bg-sec-400">
    ...
    @guest
        <header>
            <nav class="bg-sec-600 border-gray-200 px-4 lg:px-6 py-4 dark:bg-gray-800 text-white" style="background: #1f2937">
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl drop-shadow-2xl">
                    {{-- LOGO --}}
                    <a href="{{ route('home') }}" class="flex items-center" style="min-width: 300px;">
                        <img loading="lazy" src="/images/logo-mmc-new.webp" class="mr-3 h-9" alt="Flowbite Logo" />
                        <span class="text-3xl font-bold" style="color: #ff9b00;">RENT ROVER</span>
                    </a>

                    {{-- login & Register buttons --}}
                    <div class="flex items-center justify-end lg:order-2" style="min-width: 300px;">
                        <a href="{{ route('login') }}">
                            <button type="button"
                        ...
                        <a href="{{ route('register') }}">
                            <button
                                ...
                                <span
                                    class="relative px-4 py-2 transition-all ease-in duration-75 bg-sec-600 dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                                    Register
                                </span>
                            </button>
            ...
            <nav class="bg-sec-600 border-gray-200 px-4 lg:px-6 py-4 dark:bg-gray-800 text-white" style="background: #1f2937">
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    @if (Auth::user()->role == 'admin')
                        <div class="hidden justify-between item-center items-center w-full lg:flex lg:w-auto" id="mobile-menu-2">
                        ...
                        <div class="flex justify-end items-center" style="min-width: 300px;">
    ...
    @else
    <footer class="bg-gray-800 py-4 px-4 sm:px-6 w-full bottom-0">
        <div class="pt-10 mx-auto max-w-screen-xl relative">
                <div class="md:flex md:justify-between">
                    <div class="mb-12 md:mb-0 flex justify-center md:justify-start">
                        <div class="flex flex-col">
                            <a href="" class="flex items-center">
                                <img loading="lazy" src="/images/logo-mmc-new.webp" class="mr-3 h-16"
                                    alt="Logo" />
                                    <span class="text-5xl font-bold mb-2 ms-3" style="color: #ff9b00;">RENT ROVER</span>
                            </a>
                            <p class="text-gray-400 mt-2" style="max-width: 400px;">Your trusted partner in car rentals. Experience the best service and quality vehicles with Rent Rover.</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-8 ">
                        ...
                        <div>
                            ...
                            <ul class="text-gray-400">
                                <li class="mb-4">
                                    <a href="https://github.com/abdulnouralzoubi" class="hover:underline "
                ...
                <div class="sm:flex sm:items-center sm:justify-between md:ms-0 pb-4  ms-32">
                    ...
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="https://github.com/abdulnouralzoubi" target='_blank'
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        if (document.body.scrollHeight > 1500) {
                            ...
                            scrollToTopButton.href = "javascript:void(0);";
                            scrollToTopButton.onclick = scrollToTop;
                            scrollToTopButton.className = "text-white absolute top-4 md:-right-8 -right-2";
                            ...
                            `;
                            document.querySelector('footer > div').appendChild(scrollToTopButton);
                        }
                    });
                </script>
                </div>
