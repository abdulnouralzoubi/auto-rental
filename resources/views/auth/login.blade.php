...
@section('content')
    <div class="flex items-center justify-center" style="min-height: 541px">
        <div class="border p-5 md:w-1/2 w-4/5 bg-sec-100 h-auto">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="mt-4">
                        Don't have an account yet? <a class="font-medium hover:text-pr-400" href="{{route('register')}}">register here</a>
                    </div>
                </div>
            </form>
        </div>
