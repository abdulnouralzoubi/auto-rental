            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}"
                        class="bg-pr-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-pr-500 focus:border-pr-500 block w-full p-2">
                    @error('name')
                ...
                <div class="flex md:flex-row flex-col justify-evenly px-4 py-2 items-center text-center">
                ...
                <div class="mb-4">
                    <label for="password-confirm" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Confirm Password:</label>
                ...
                <div class="mb-4">
                    ...
                    <select id="role" name="role" class="bg-pr-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-pr-500 focus:border-pr-500 block w-full p-2">
                        <option value="client" {{ old('role') == 'client' ? 'selected' : '' }}>Client</option>
                        <option value="lessor" {{ old('role') == 'lessor' ? 'selected' : '' }}>Lessor</option>
                    </select>
                    @error('role')
                        <span class="text-red-600">{{ $message }}</span>
                    @enderror
                ...
                <button type="submit"
                    class="text-white bg-pr-400 hover:bg-pr-600 focus:ring-4 focus:outline-none focus:ring-pr-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-pr-600 dark:hover:bg-pr-700 dark:focus:ring-pr-800 mx-auto block">Register</button>
