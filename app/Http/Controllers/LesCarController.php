...
class LesCarController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('lessor.cars.index');
    }
    ...
    public function edit(Car $car)
    {
        ...
        return view('lessor.updateCar', compact('car'));
    }
    ...
    public function destroy(Car $car)
    {
        ...
        if ($activeReservations > 0) {
            ...
            return redirect()->route('lessor.cars.index')->with('error', 'Cannot delete car with active reservations.');
        }
        ...
        return redirect()->route('lessor.cars.index')->with('success', 'Car deleted successfully.');
    }
}
